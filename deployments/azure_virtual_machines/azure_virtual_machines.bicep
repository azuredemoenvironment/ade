...
// Parameters
@description('Parameter for the default primary Azure region. Currently set to East US. Defined in azure_virtual_machines_parameters.json.')
param defaultPrimaryRegion string

@description('Parameter for the user alias and default primary Azure region defined from user input. Defined in azure_virtual_machines_parameters.json.')
param aliasRegion string

@description('Parameter for the administrator user name for the virtual machine. Defined in azure_virtual_machines_parameters.json.')
